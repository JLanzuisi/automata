...
static inline bool flag_names_unique(const char *long_name,
                                     const char *short_name) {
...
static inline void c_flags_parse(int *argc_ptr, char ***argv_ptr,
    ...
    while (arg < argc) {
        ...
        switch (flag->type) {
        case C_FLAG_INT:
            C_FLAG_LOAD_SIGNED_VALUE(flag, flag_long, int, value,
                                     usage_on_error)
            break;
        case C_FLAG_INT_8:
            C_FLAG_LOAD_SIGNED_VALUE(flag, flag_long, int8_t, value,
                                     usage_on_error)
            break;
        case C_FLAG_INT_16:
            C_FLAG_LOAD_SIGNED_VALUE(flag, flag_long, int16_t, value,
                                     usage_on_error)
            break;
        case C_FLAG_INT_32:
            C_FLAG_LOAD_SIGNED_VALUE(flag, flag_long, int32_t, value,
                                     usage_on_error)
            break;
        case C_FLAG_INT_64:
            C_FLAG_LOAD_SIGNED_VALUE(flag, flag_long, int64_t, value,
                                     usage_on_error)
            break;
        case C_FLAG_UNSIGNED:
            C_FLAG_LOAD_UNSIGNED_VALUE(flag, flag_long, unsigned, value,
                                       usage_on_error)
            break;
        case C_FLAG_UINT_8:
            C_FLAG_LOAD_UNSIGNED_VALUE(flag, flag_long, uint8_t, value,
                                       usage_on_error)
            break;
        case C_FLAG_UINT_16:
            C_FLAG_LOAD_UNSIGNED_VALUE(flag, flag_long, uint16_t, value,
                                       usage_on_error)
            break;
        case C_FLAG_UINT_32:
            C_FLAG_LOAD_UNSIGNED_VALUE(flag, flag_long, uint32_t, value,
                                       usage_on_error)
            break;
        case C_FLAG_UINT_64:
            C_FLAG_LOAD_UNSIGNED_VALUE(flag, flag_long, uint64_t, value,
                                       usage_on_error)
            break;
        case C_FLAG_SIZE_T:
            C_FLAG_LOAD_UNSIGNED_VALUE(flag, flag_long, size_t, value,
                                       usage_on_error)
            break;
        case C_FLAG_BOOL:
